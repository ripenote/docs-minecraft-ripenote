...
if __name__ == '__main__':
    ...
    base_img = add_centered_text(base_img, '/execute コマンド', font_black_path, 64, (64, 64, 64), 280)
    base_img = add_centered_text(base_img, 'Created by tamagoez', font_medium_path, 32, (120, 120, 120), 450)

    base_img.show()
    print(CONST_REQUEST_PATH)
    # https://note.nkmk.me/python-os-mkdir-makedirs/
    MAKEDIR = 'output/' + os.path.dirname(CONST_REQUEST_PATH)
    ...
    SAVEDIR = MAKEDIR + '/' + os.path.splitext(os.path.basename(CONST_REQUEST_PATH))[0] + '.png'
