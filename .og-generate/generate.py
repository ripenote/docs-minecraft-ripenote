...
if __name__ == '__main__':
    ...
    base_img = add_centered_text(base_img, '/execute コマンド', font_black_path, 64, (64, 64, 64), 250)
    base_img = add_centered_text(base_img, 'Created by tamagoez', font_medium_path, 32, (120, 120, 120), 470)
